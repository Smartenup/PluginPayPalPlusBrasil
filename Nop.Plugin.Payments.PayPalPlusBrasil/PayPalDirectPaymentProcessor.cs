...
namespace Nop.Plugin.Payments.PayPalPlusBrasil
{
    ...
    public class PayPalPlusBrasilPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public PayPalPlusBrasilPaymentProcessor(PayPalPlusBrasilPaymentSettings PayPalPlusBrasilPaymentSettings,
        ...
        {
            this._PayPalPlusBrasilPaymentSettings = PayPalPlusBrasilPaymentSettings;
        ...
        //    //var url = _PayPalPlusBrasilPaymentSettings.UseSandbox ? "https://api-3t.sandbox.paypal.com/2.0" : "https://api-3t.paypal.com/2.0";
        //    //var mode = _PayPalPlusBrasilPaymentSettings.UseSandbox ? "sandbox" : "live";

        //    //config.Add("PayPalAPI", url);
        //    //config.Add("mode", mode);
        //    //config.Add("account0.apiUsername", _PayPalPlusBrasilPaymentSettings.ApiAccountName);
        //    //config.Add("account0.apiPassword", _PayPalPlusBrasilPaymentSettings.ApiAccountPassword);
        //    //config.Add("account0.apiSignature", _PayPalPlusBrasilPaymentSettings.Signature);
        ...
        {
            if (_PayPalPlusBrasilPaymentSettings.TransactMode == TransactMode.Authorize)
            {
        ...
        public decimal GetAdditionalHandlingFee(IList<ShoppingCartItem> cart)
        {
            var result = this.CalculateAdditionalFee(_orderTotalCalculationService, cart,
                _PayPalPlusBrasilPaymentSettings.AdditionalFee, _PayPalPlusBrasilPaymentSettings.AdditionalFeePercentage);
            return result;
        }
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.TransactMode", "Transaction mode");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.TransactMode.Hint", "Specify transaction mode.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountName", "API Account Name");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountName.Hint", "Specify API account name.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountPassword", "API Account Password");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountPassword.Hint", "Specify API account password.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.Signature", "Signature");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.Signature.Hint", "Specify signature.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFee", "Additional fee");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFee.Hint", "Enter additional fee to charge your customers.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFeePercentage", "Additional fee. Use percentage");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFeePercentage.Hint", "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.TransactMode");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.TransactMode.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountName");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountName.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountPassword");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.ApiAccountPassword.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.Signature");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.Signature.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFee");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFee.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFeePercentage");
            this.DeletePluginLocaleResource("Plugins.Payments.PayPalPlusBrasil.Fields.AdditionalFeePercentage.Hint");
