...
{
    public class PayPalPlusObjectContext : DbContext, IDbContext
    {
        public PayPalPlusObjectContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        ...
        {
            modelBuilder.Configurations.Add(new CustomerPayPalPlusMap());
            modelBuilder.Configurations.Add(new OrderNotePayPalPlusMap());
